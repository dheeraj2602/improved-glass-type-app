...
plot_list = st.sidebar.multiselect("Select the Charts/Polts:", ('Correlation Heatmap', 'Line Chart', 'Area Chart', 'Count Plot','Pie Chart', 'Box Plot'))
...
if 'Box Plot' in plot_list:
    ...
    feature_col = st.sidebar.selectbox("Select the variable for boxplot:", ('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
    plt.figure(figsize=(9,5))
    sns.boxplot(glass_df[feature_col])
    st.pyplot()
